...
(function () {
    ...
    class JavLibrary extends Base {
        ...
        detailPage() {
            ...
            //添加跳转到javlibrary链接
            info.append("<div class='item'><table><tbody><tr><td class='header'><a class='red' href='https://https://www.busfan.cc/" + code + "' target='_blank'>javbus</a></td></tr></tbody></table></div>");
            //演员
